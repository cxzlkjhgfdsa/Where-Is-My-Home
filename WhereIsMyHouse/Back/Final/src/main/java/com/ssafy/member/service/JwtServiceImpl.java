...
public class JwtServiceImpl implements JwtService {
	...
	private static final int ACCESS_TOKEN_EXPIRE_MINUTES = 10; // 10분
	private static final int REFRESH_TOKEN_EXPIRE_MINUTES = 10; // 10시간
...
//	AccessToken에 비해 유효기간을 길게...
	...
	public <T> String createRefreshToken(String key, T data) {
		return create(key, data, "refresh-token", 1000 * 60 * 60 * REFRESH_TOKEN_EXPIRE_MINUTES);   // 시간단위로 변경
